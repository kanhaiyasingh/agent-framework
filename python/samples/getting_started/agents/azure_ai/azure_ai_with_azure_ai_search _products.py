...
USER_INPUTS = [
    "Search the right product for outdoor camping and cooking that can help start a campfire.",
]
...
async def main() -> None:
    ...
    azure_ai_search_tool = HostedFileSearchTool(
        additional_properties={
            "index_name": "contoso-products",  # Name of your search index
    ...
    async with (
        ...
        ChatAgent(
            ...
            instructions=("You are a helpful shopping assistant that searches product information."),
            tools=azure_ai_search_tool,
        ) as agent,
    ):
        print("=== Azure AI Agent with Azure AI Search ===")
        print("This agent can search through product data to help you find the right products.\n")
        ...
        print("Product search conversation completed!")
